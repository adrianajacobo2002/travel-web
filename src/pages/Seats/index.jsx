  ...
  return (
    ...
    >
      ...
      >
        ...
        <Grid id="leftPanelGrid" name="leftPanelGrid" item xs={12} md={4}>
          <Card
          ...
          >
            ...
            <FormControl
              ...
              variant="standard"
            >
              <FormGroup id="seatLegendFormGroup" name="seatLegendFormGroup">
                <FormControlLabel
        ...
        <Grid id="seatMapGrid" name="seatMapGrid" item xs={12} md={8}>
          <Card
            id="seatMapCard"
            name="seatMapCard"
            sx={{
